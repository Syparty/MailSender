...
namespace MailSenderLib.Data.Linq2SQL
{
    ...
    partial void InsertRecipents(Recipents instance);
    partial void UpdateRecipents(Recipents instance);
    partial void DeleteRecipents(Recipents instance);
    #endregion
		
		public MailSenderDBDataContext() : 
				base(global::MailSenderLib.Properties.Settings.Default.MailSenderDBConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<Recipents> Recipents
		{
			get
			{
				return this.GetTable<Recipents>();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.Recipents")]
	public partial class Recipents : INotifyPropertyChanging, INotifyPropertyChanged
	{
